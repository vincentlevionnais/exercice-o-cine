 ...
 */
final class Version20210729131720 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(211) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, release_date DATETIME NOT NULL, duration SMALLINT NOT NULL, poster VARCHAR(255) DEFAULT NULL, rating SMALLINT DEFAULT NULL, title_slug VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
