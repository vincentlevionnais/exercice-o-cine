 ...
 */
final class Version20210730084628 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movie (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(211) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, release_date DATETIME NOT NULL, duration SMALLINT NOT NULL, poster VARCHAR(255) DEFAULT NULL, rating SMALLINT DEFAULT NULL, slug VARCHAR(211) NOT NULL, UNIQUE INDEX UNIQ_1D5EF26F989D9B62 (slug), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
